...
var rechargeAddress = "0x04e44ec5147b6d49cc0838f19c1f545b6291e144";
...
var tradeAddress = "0xa2057f186df5e770b9715215c6695a2104d5439f"
...
function initGameToken(player,gameId,channel,aliasName,callback){
    var das = web3.eth.contract(dasABI).at(dasAddress);
    player = "0x" + player;
    token = das.getPlayerToken(player,gameId);
    if(token == '0x'){
